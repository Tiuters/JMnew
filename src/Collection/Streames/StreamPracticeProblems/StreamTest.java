package Collection.Streames.StreamPracticeProblems;
...
// ************************************************************************************************************************
        ...
        */
        ...
        Optional<Student> st1 = students.stream()
            .filter(s -> Objects.equals(s.getName(), "Jayesh"))
            .findFirst();
        System.out.println(st1.isPresent() ? st1.get().getName() : "Not found");

        Optional<Student> st2 = students.stream()
                .filter(s -> s.getAddress().getZipcode().equals("1235"))
                .findFirst();
        System.out.println(st2.isPresent() ? st2.get().getName() : "Not found");
